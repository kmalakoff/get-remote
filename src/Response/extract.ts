...
import type { Callback, Options, StreamOptions } from '../types.ts';
...
function worker(this: Response, dest: string, options: Options, callback: Callback) {
  ...
  this.stream(options as StreamOptions, (err, res) => {
...
export default function extract(this: Response, dest: string, options?: Options | Callback, callback?: Callback): void | Promise<void> {
